...
export const CLIENTS: Client[] = [
  ...
  { name: "Abu Dhabi Ports", abbr: "PORTS", color: "#123A63", sub: "موانئ أبوظبي", logo: "/clients/adp.png" },
  { name: "Hassantuk", abbr: "حصنتك", color: "#2E9E44", sub: "Smart Protection", logo: "/clients/hassantuk.png" },
  { name: "GASCO", abbr: "GASCO", color: "#1B75BB", sub: "Gas Industries Ltd.", logo: "/clients/adcs.png" },
  { name: "Al Dhafra Co-op Society", abbr: "ADCS", color: "#8A6D3B", logo: "/clients/taqa.png" },
  { name: "ADCO", abbr: "ADCO", color: "#1B75BB", sub: "Onshore Oil Operations", logo: "/clients/adco.png" },
  { name: "Al Hosn Gas", abbr: "AL HOSN", color: "#1B75BB", sub: "الحصن للغاز", logo: "/clients/alhosn.png" },
  { name: "SIBCA", abbr: "SIBCA", color: "#E8321F", sub: "سيبكا", logo: "/clients/sibca.png" },
