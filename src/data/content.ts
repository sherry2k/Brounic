...
export type Project = {
  title: string;
  category: "Commercial" | "Industrial" | "Residential" | "Oil & Gas" | "Labor Camp";
  location: string;
  system: string;
  date: string;
  img: string;
